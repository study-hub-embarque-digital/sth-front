...
import styles from "./QuantasAtividades.module.scss";
...
const QuantasAtividades = () => {
  ...
  const series = [
    {
      ...
      data: [
        ...
        1188, 1879, 626, 1635, 2177, 516, 1793, 1598,
      ],
    },
    {
      label: "series 2",
    ...
    },
    {
      label: "series 5",
      data: [
        968, 1371, 1381, 1060, 1327, 934, 1779, 1361, 878, 1055, 1737, 2380,
        875, 2408, 1066, 1802, 1442, 1567, 1552, 1742,
      ],
    },
    {
      label: "series 6",
    ...
    },
    {
      label: "series 7",
      data: [
        2140, 2082, 708, 2032, 554, 1365, 2121, 1639, 2430, 2440, 814, 1328,
        883, 1811, 2322, 1743, 700, 2131, 1473, 957,
      ],
    },
    {
      label: "series 8",
      data: [
        1074, 744, 2487, 823, 2252, 2317, 2139, 1818, 2256, 1769, 1123, 1461,
        672, 1335, 960, 1871, 2305, 1231, 2005, 908,
      ],
    },
    {
      label: "series 9",
  ...
  return (
    <div
      className={styles.QuantasAtividades}
      style={{
    ...
    >
      <Typography className={styles.title}>
        Quantas atividades entregou x quantas faltam
      </Typography>
      <BarChart
        height={200}
        series={series
...
export default QuantasAtividades;
