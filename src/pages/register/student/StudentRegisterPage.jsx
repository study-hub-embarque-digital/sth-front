import { Box, TextField, Button, Typography, IconButton, InputAdornment, AppBar, Toolbar, Select, MenuItem, FormControl, InputLabel } from '@mui/material';
import { Visibility, VisibilityOff } from '@mui/icons-material';
import logoLogin from "@assets/logoLogin.png";
import logo from "@assets/logoInitial.png";
import { useStudentRegisterPageHook } from './StudentRegisterPageHook';
        ...
        >
          ...
          >
            ...
            <FormControl fullWidth>
              <InputLabel id="demo-simple-select-label">Instituição de Ensino</InputLabel>
              <Select
              ...
              >
                {
                  instituicoesEnsino.map(instituicao => {
                    return (
                      <MenuItem key={instituicao?.instituicaoEnsinoId} value={instituicao?.instituicaoEnsinoId}>{instituicao?.nome}</MenuItem>
                    )
                  })
                }
              </Select>
