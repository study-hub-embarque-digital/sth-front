...
import { useRepresentanteRegisterPageHook } from './RepresentanteRegisterPageHook';
import { Navigate } from 'react-router-dom';
import { useAuth } from '../../../hooks/useAuth';

const RepresentanteRegisterPage = () => {
  const [
    showPassword,
    setShowPassword,
    showConfirmPassword,
    ...
    loading,
    empresas
  ] = useRepresentanteRegisterPageHook();
              ...
              >
                {
                  empresas.map(empresa => {
                    return (
                      <MenuItem key={empresa?.empresaId} value={empresa?.empresaId}>{empresa?.nomeFantasia}</MenuItem>
                    )
                  })
                }
              </Select>
...
export default RepresentanteRegisterPage;
